...
- [x] P2-1: Markdown cache — skip streaming entries (markdown.js)
- [x] P2-3: Streaming string concat → array join (streaming.js, backgroundRouting.js)
- [x] P2-5: `toolExpand` remove `max-height` animation (tools.css)
- [x] P3-7: Scope highlight `querySelectorAll` to `.message-list` (appHelpers.js)
