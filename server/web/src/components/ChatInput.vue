...
<template>
          <div class="input-area" v-if="(viewMode === 'chat' && currentView === 'chat') || currentView === 'recap-detail' || currentView === 'briefing-detail'">
            ...
            <div v-if="usageStats && currentView !== 'recap-detail' && currentView !== 'briefing-detail'" class="usage-bar">{{ formatUsage(usageStats) }}</div>
            ...
            <div
              :class="['input-card', { 'drag-over': dragOver, 'plan-mode': planMode, 'brain-mode': brainMode && currentView !== 'recap-detail' && currentView !== 'briefing-detail' }]"
            ...
            >
              ...
              <div class="input-bottom-row">
                <div class="input-bottom-left">
                  ...
                  <button :class="['plan-mode-btn', { active: planMode }]" @click="togglePlanMode" :disabled="isProcessing" :title="planMode ? 'Switch to Normal Mode' : 'Switch to Plan Mode'" v-if="currentView !== 'recap-detail' && currentView !== 'briefing-detail'">
                  ...
                  <button v-if="showBrainButton && currentView !== 'recap-detail' && currentView !== 'briefing-detail'" :class="['brain-mode-btn', { active: brainMode, locked: brainModeLocked }]" @click="toggleBrainMode" :disabled="brainModeLocked || isProcessing || !!currentClaudeSessionId" :title="brainMode ? 'Brain Mode (active)' : 'Enable Brain Mode'">
