            ...
            <div class="sidebar-workdir">
              ...
              <div v-if="viewMode === 'feed'" class="feed-sidebar">
                <div class="feed-sidebar-nav">
                  ...
                  <button class="feed-sidebar-btn" :class="{ active: currentView === 'project-feed' || currentView === 'project-detail' }" @click="store.requireVersion('0.1.236', 'Project Knowledge Base') && (currentView = 'project-feed')">
                    <span class="feed-sidebar-icon">&#x1F4DA;</span>
                    Projects
                  </button>
                </div>
