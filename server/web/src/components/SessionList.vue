...
<template>
  <div class="sidebar-section sidebar-sessions" :style="{ flex: chatsCollapsed ? '0 0 auto' : '1 1 0', minHeight: chatsCollapsed ? 'auto' : '0' }">
    <div class="sidebar-section-header" v-if="!sessionSearchOpen" @click="chatsCollapsed = !chatsCollapsed" style="cursor: pointer;">
      <span class="sidebar-section-header-left">
        <svg :class="['sidebar-section-chevron', { collapsed: chatsCollapsed }]" viewBox="0 0 24 24" width="12" height="12"><path fill="currentColor" d="M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6z"/></svg>
        {{ t('sidebar.chatHistory') }}
      </span>
      <span v-show="!chatsCollapsed" class="sidebar-section-header-actions">
